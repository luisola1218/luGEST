...
def _nota_encomenda_last_delivery_date(ne):
    from lugest_modules.purchasing.application.note_status import last_delivery_date
    return last_delivery_date(ne)


def normalize_nota_encomenda_estado(ne):
    from lugest_modules.purchasing.application.note_status import normalize_status
    return normalize_status(ne, parse_float, norm_text)
