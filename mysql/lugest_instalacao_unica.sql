...
CREATE TABLE IF NOT EXISTS `faturacao_registos` (
  ...
  `valor_venda_manual` decimal(12,2) DEFAULT NULL,
  `estado_pagamento_manual` varchar(30) DEFAULT NULL,
  `obs` text,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`numero`),
...
CREATE TABLE IF NOT EXISTS `orc_referencias_historico` (
  ...
  `tempo_peca_min` decimal(10,3) DEFAULT NULL,
  `operacoes_json` longtext,
  `tempos_operacao_json` longtext,
  `custos_operacao_json` longtext,
  `quote_cost_snapshot_json` longtext,
  `origem_doc` varchar(30) DEFAULT NULL,
  `origem_tipo` varchar(80) DEFAULT NULL,
  `estado_origem` varchar(80) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `transportes` (
  ...
  `numero` varchar(30) DEFAULT NULL,
  `ano` int(11) DEFAULT NULL,
  `tipo_responsavel` varchar(40) DEFAULT NULL,
  `estado` varchar(40) DEFAULT NULL,
  `data_planeada` date DEFAULT NULL,
  `hora_saida` varchar(10) DEFAULT NULL,
  `viatura` varchar(120) DEFAULT NULL,
  `matricula` varchar(30) DEFAULT NULL,
  `motorista` varchar(120) DEFAULT NULL,
  `telefone_motorista` varchar(40) DEFAULT NULL,
  `origem` varchar(255) DEFAULT NULL,
  `observacoes` text,
  `created_by` varchar(80) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `transportadora_id` varchar(30) DEFAULT NULL,
  ...
  `paletes_total_manual` decimal(10,2) DEFAULT NULL,
  `peso_total_manual_kg` decimal(12,2) DEFAULT NULL,
  `volume_total_manual_m3` decimal(12,3) DEFAULT NULL,
  `pedido_transporte_estado` varchar(40) DEFAULT NULL,
  `pedido_transporte_ref` varchar(80) DEFAULT NULL,
  `pedido_transporte_at` datetime DEFAULT NULL,
  `pedido_transporte_by` varchar(80) DEFAULT NULL,
  `pedido_transporte_obs` text,
  `pedido_resposta_obs` text,
  `pedido_confirmado_at` datetime DEFAULT NULL,
  `pedido_confirmado_by` varchar(80) DEFAULT NULL,
  `pedido_recusado_at` datetime DEFAULT NULL,
  `pedido_recusado_by` varchar(80) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `numero` (`numero`),
...
CREATE TABLE IF NOT EXISTS `transportes_tarifarios` (
  ...
  `valor_por_palete` decimal(12,2) DEFAULT NULL,
  `valor_por_kg` decimal(12,4) DEFAULT NULL,
  `valor_por_m3` decimal(12,2) DEFAULT NULL,
  `custo_minimo` decimal(12,2) DEFAULT NULL,
  `ativo` tinyint(1) DEFAULT NULL,
  `observacoes` text,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `encomendas` (
  ...
  `observacoes` text,
  `ano` int(11) DEFAULT NULL,
  `posto_trabalho` varchar(80) DEFAULT NULL,
  `nota_transporte` text,
  `preco_transporte` decimal(12,2) DEFAULT NULL,
  `local_descarga` varchar(255) DEFAULT NULL,
  `transporte_numero` varchar(30) DEFAULT NULL,
  `estado_transporte` varchar(50) DEFAULT NULL,
  `custo_transporte` decimal(12,2) DEFAULT NULL,
  `paletes` decimal(10,2) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `faturacao_faturas` (
  ...
  `documento_id` varchar(60) DEFAULT NULL,
  ...
  `seq_num` int(11) DEFAULT NULL,
  `at_validation_code` varchar(40) DEFAULT NULL,
  `atcud` varchar(80) DEFAULT NULL,
  `moeda` varchar(10) DEFAULT NULL,
  `iva_perc` decimal(6,2) DEFAULT NULL,
  `subtotal` decimal(12,2) DEFAULT NULL,
  ...
  `legal_invoice_no` varchar(80) DEFAULT NULL,
  `system_entry_date` datetime DEFAULT NULL,
  `source_id` varchar(80) DEFAULT NULL,
  `source_billing` varchar(1) DEFAULT NULL,
  `status_source_id` varchar(80) DEFAULT NULL,
  `hash` varchar(512) DEFAULT NULL,
  `hash_control` varchar(80) DEFAULT NULL,
  `previous_hash` varchar(512) DEFAULT NULL,
  `document_snapshot_json` longtext,
  `communication_status` varchar(30) DEFAULT NULL,
  `communication_filename` varchar(255) DEFAULT NULL,
  `communication_error` text,
  `communicated_at` datetime DEFAULT NULL,
  `communication_batch_id` varchar(80) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_fat_faturas_reg` (`registo_numero`),
  KEY `idx_fat_faturas_doc` (`documento_id`),
  KEY `idx_fat_faturas_emissao` (`data_emissao`),
  KEY `idx_fat_faturas_serie_seq` (`serie_id`,`seq_num`),
...
CREATE TABLE IF NOT EXISTS `faturacao_pagamentos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `registo_numero` varchar(30) NOT NULL,
  `pagamento_id` varchar(60) DEFAULT NULL,
  `fatura_documento_id` varchar(60) DEFAULT NULL,
  `data_pagamento` date DEFAULT NULL,
  `valor` decimal(12,2) DEFAULT NULL,
  `metodo` varchar(40) DEFAULT NULL,
  `referencia` varchar(120) DEFAULT NULL,
  `titulo_comprovativo` varchar(150) DEFAULT NULL,
  `caminho_comprovativo` varchar(512) DEFAULT NULL,
  `obs` text,
  `created_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_fat_pag_reg` (`registo_numero`),
...
CREATE TABLE IF NOT EXISTS `transportes_paragens` (
  ...
  `data_planeada` datetime DEFAULT NULL,
  `estado` varchar(40) DEFAULT NULL,
  `observacoes` text,
  `paletes` decimal(10,2) DEFAULT NULL,
  `peso_bruto_kg` decimal(12,2) DEFAULT NULL,
  ...
  `referencia_transporte` varchar(80) DEFAULT NULL,
  `zona_transporte` varchar(120) DEFAULT NULL,
  `check_carga_ok` tinyint(1) DEFAULT NULL,
  `check_docs_ok` tinyint(1) DEFAULT NULL,
  `check_paletes_ok` tinyint(1) DEFAULT NULL,
  `pod_estado` varchar(40) DEFAULT NULL,
  `pod_recebido_nome` varchar(120) DEFAULT NULL,
  `pod_recebido_at` datetime DEFAULT NULL,
  `pod_obs` text,
  PRIMARY KEY (`id`),
