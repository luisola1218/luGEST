...
if ($SafeOnly) {
    ...
    $safeScripts = @(
        ...
        'scripts\verify_transport_tariffs.py',
        'scripts\verify_transport_stops.py',
        'scripts\verify_transport_trips.py',
        'scripts\verify_transport_assignments.py',
        'scripts\verify_transport_queries.py',
        ...
        'scripts\verify_quote_order_lines.py',
        'scripts\verify_quote_routing.py',
        'scripts\verify_assembly_model_editor.py',
        'scripts\verify_quote_conversion.py',
        'scripts\verify_purchase_needs.py',
        'scripts\verify_quote_editors.py',
        'scripts\verify_calculated_assembly_editor.py',
