...
def main() -> int:
    parser = argparse.ArgumentParser(description="Prepara um lote interno para comunicação AT a partir das faturas pendentes.")
    ...
    rendered = backend.billing_prepare_at_communication_batch(
