...
def main():
    ...
    for method, target in {'client_rows': 'ClientService.rows',
                           ...
                           'orc_create_purchase_quote': 'PurchaseQuote.create',
                           ...
                           'transport_assign_orders': 'TripAssignments.assign',
                           'billing_add_payment': 'Payments.add',
                           'quality_nc_save': 'Nonconformities.save',
                           'quality_nc_release_material': 'MaterialRelease.release',
                           'quality_reception_save': 'Receptions.save',
                           'quality_summary': 'QualityQueries.summary',
                           ...
                           'ne_save': 'NoteCommands.save',
                           '_ne_normalize_line': 'PurchaseLines.normalize',
