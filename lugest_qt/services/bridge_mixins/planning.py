...
from lugest_infra.pdf.dossier_reports import render_planning_deadlines as _render_dossier_planning_deadlines
from lugest_infra.pdf.dossier_reports import render_planning_order as _render_dossier_planning_order
...
class PlanningBridgeMixin:
    ...
    def planning_render_laser_deadlines_pdf(self, output_path: str = "") -> Path:
        ...
        return _render_dossier_planning_deadlines(self, path, rows)
    ...
    def planning_render_order_detail_pdf(
        ...
        *,
        ...
        return _render_dossier_planning_order(
            self,
            path,
            detail,
            flow_rows,
