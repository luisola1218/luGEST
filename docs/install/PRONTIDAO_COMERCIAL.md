...
3. Concluir testes de instalacao num computador Windows limpo e numa rede multiutilizador real.
4. Formalizar licenca, contrato de suporte, politica de privacidade/RGPD e procedimento de recuperacao de desastre.
5. Submeter e obter certificacao da Autoridade Tributaria antes de comercializar o modulo como software de faturacao certificado.
